...
def visualize_faiss_vectors_umap(faiss_index, file_names=None, clusters=5):
    """
    ...
    plt.title("FAISS Vectors Visualization (UMAP)")
...
if __name__ == "__main__":
    ...
    # FAISS 벡터 시각화
    visualize_faiss_vectors_umap(faiss_index, file_names=file_names, clusters=5)
