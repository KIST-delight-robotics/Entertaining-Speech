#okt 이용 GPT response(B)에서 형태소 키워드 추출
...
if __name__ == '__main__':
    ...
    print(f"OKT Keyword Extraction Time: {l_keyword_time:.2f} seconds")
    print(f"Main Keyword Extraction Time: {s_keywords_time:.2f} seconds")
